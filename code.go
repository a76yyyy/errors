...
var (
	unknownCoder defaultCoder = defaultCoder{1, http.StatusInternalServerError, "An internal server error occurred", "http://github.com/a76yyyy/errors/README.md"}
)
...
func Register(coder Coder) {
	if coder.Code() == 1 {
		panic("code `1` is reserved by `github.com/marmotedu/errors` as unknownCode error code")
	}
...
func MustRegister(coder Coder) {
	if coder.Code() == 1 {
		panic("code '1' is reserved by 'github.com/marmotedu/errors' as ErrUnknown error code")
	}
